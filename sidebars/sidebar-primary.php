...
<?php elseif ( get_field('display_office_information', 'options') ): ?>
	...
	<div class="sidebar">
		...
		<div class="angies_wrapper">
		
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/angies.png" alt="angies award" />
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/angies2014.png" alt="angies award" />
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/angies2015.png" alt="angies award" />
